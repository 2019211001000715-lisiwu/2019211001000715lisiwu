...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //http://localhost:8080/2019211001000715lisiwu_war_exploded/redirect
        //http://localhost:8080/2019211001000715lisiwu_war_exploded/index.jsp
        //see the url-only last part of url changed(redirect-->index.jsp)


        System.out.println("after redirect");
        //2.start with/
//        response.sendRedirect("/2019211001000715lisiwu_war_exploded/index.jsp");//-???
        //why ?-look at url
        //http://localhost:8080/2019211001000715lisiwu_war_exploded/redirect
        //http://localhost:8080/index.jsp
        //url change after 8080 - means tomcat
        //add /2019211001000715lisiwu_war_exploded/
