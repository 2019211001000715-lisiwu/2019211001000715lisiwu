...
import com.Lisiwu.model.Payment;
...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int customerId=request.getParameter("customerId")!=null?Integer.parseInt(request.getParameter("customer")):0;
        ...
        double orderTotal=request.getParameter("orderTotal")!=null?Integer.parseInt(request.getParameter("orderTotal")):0.0;
